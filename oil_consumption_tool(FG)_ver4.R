...
dsx_lag4 <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/Forecast/DSX Forecast Backup - 2024.06.03.xlsx")
dsx_lag3 <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/Forecast/DSX Forecast Backup - 2024.07.02.xlsx")
dsx_lag2 <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/Forecast/DSX Forecast Backup - 2024.08.02.xlsx")
dsx_lag1 <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/Forecast/DSX Forecast Backup - 2024.09.03.xlsx")

dsx_1 <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/Forecast/DSX Forecast Backup - 2024.10.01.xlsx")
dsx_2 <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/Forecast/DSX Forecast Backup - 2024.11.01.xlsx")
dsx_3 <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/Forecast/DSX Forecast Backup - 2024.12.02.xlsx")
dsx_4 <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/Forecast/DSX Forecast Backup - 2025.01.02.xlsx")
dsx_5 <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/Forecast/DSX Forecast Backup - 2025.02.03.xlsx")
dsx_6 <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/Forecast/DSX Forecast Backup - 2025.03.03.xlsx")
dsx_7 <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/Forecast/DSX Forecast Backup - 2025.04.01.xlsx")
dsx_8 <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/Forecast/DSX Forecast Backup - 2025.05.01.xlsx")
dsx_9 <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/Forecast/DSX Forecast Backup - 2025.06.03.xlsx")
dsx_10 <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/Forecast/DSX Forecast Backup - 2025.07.03.xlsx")
dsx_11 <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/Forecast/DSX Forecast Backup - 2025.08.05.xlsx")
dsx_12 <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/Forecast/DSX Forecast Backup - 2025.09.02.xlsx")
######################################################### Other List ######################################################

# BoM RM to sku 
rm_to_sku <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/IQR Automation/RM/Weekly Run Files/2025/09.02.2025/Raw Material Inventory Health (IQR) NEW TEMPLATE - 09.02.2025.xlsx", 
                        sheet = "RM to SKU")

# BoM Report 
bom <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/File Repository/IQR Automation/RM/Weekly Run Files/2025/09.02.2025/Raw Material Inventory Health (IQR) NEW TEMPLATE - 09.02.2025.xlsx", 
                  sheet = "BoM")
...
bulk_oil_list <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/2025.09 Lag4/Bulk Oil Table.xlsx")
...
sku_actual <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/2025.09 Lag4/shipped.xlsx")

# Input sales orders (Make sure in the MSTR if months info input correct) 
# https://edgeanalytics.venturafoods.com/MicroStrategyLibrary/app/DF007F1C11E9B3099BB30080EF7513D2/7D421DDA4D4411DA73B4469771826BD9/W62--K46
sales_orders <- read_excel("C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/2025.09 Lag4/ordered.xlsx")
...
writexl::write_xlsx(identitied_skus_not_existing, "C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/2025.09 Lag4/Identitied skus not existing.xlsx")
...
# Export to Excel File ----
writexl::write_xlsx(final_paper, "C:/Users/SPoudel/Ventura Foods/SC Analytics Team - General/Stan Report Files/Oil Consumption/2025.09 Lag4/oil_consumption_comparison.xlsx")
